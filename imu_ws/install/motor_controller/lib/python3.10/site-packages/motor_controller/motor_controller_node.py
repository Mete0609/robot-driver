...
class MotorControllerNode(Node):
    def __init__(self):
        ...
        try:
            ...
            self.get_logger().info("串口连接成功: /dev/ttyUSB0 @ 115200")
    ...
    def parse_feedback(self, line):
        ...
        if 'L:' in line and 'R:' in line:
            try:
                ...
                self.right_encoder_pub.publish(Int32(data=-right_val))  # 右轮方向取负

                self.get_logger().debug(f"解析成功: 左轮={left_val}, 右轮={-right_val}")
            except Exception as e:
